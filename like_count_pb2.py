...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BASICINFO']._serialized_end=99
  _globals['_INFO']._serialized_start=101
  _globals['_INFO']._serialized_end=140
